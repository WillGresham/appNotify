...
hideLink.appendChild(document.createTextNode("Not Right Now"));if(this.image!==false){imageHolder=document.createElement("img");imageHolder.setAttribute("src",this.image);imageHolder.setAttribute("alt","App Icon");imageHolder.setAttribute("class","appNotify-appIcon");wrapperP.appendChild(imageHolder)}wrapperDiv.setAttribute("class","appNotify-banner");wrapperP.setAttribute("class","appNotify-p");wrapperP.appendChild(titleText);wrapperP.appendChild(br);wrapperP.appendChild(acceptLink);wrapperP.appendChild(document.createTextNode(" | "));
wrapperP.appendChild(dismissLink);wrapperP.appendChild(document.createTextNode(" | "));wrapperP.appendChild(hideLink);wrapperDiv.appendChild(wrapperP);document.body.insertBefore(wrapperDiv,document.body.childNodes[0])}};
